        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-[#F5EFE6] p-8 rounded-[40px] shadow-sm hover:shadow-md transition-all duration-500 border border-white/50">
            ...
            <div className="flex gap-4 flex-wrap">
              {[
                { 
                  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>, 
                  label: 'Instagram' 
                },
                { 
                  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-1 2.17-2 2.85c.34 3.16-1.14 6.34-3.5 8.5-2.36 2.16-5.54 3.14-8.5 2.5-3.08-.66-5.5-3.2-6-6.5.6.14 1.2.2 1.8.2 2.1 0 3.94-.87 5.33-2.3a4.12 4.12 0 0 1-3.2-3.18c.3.1.62.14.94.14.4 0 .8-.06 1.2-.18a4.1 4.1 0 0 1-3.3-4.1v-.05c.62.35 1.34.56 2.1.58a4.1 4.1 0 0 1-1.27-5.46A11.64 11.64 0 0 0 13.5 12a4.1 4.1 0 0 1 7-3.9 8.24 8.24 0 0 0 2.6-1A4.1 4.1 0 0 1 22 4z"></path></svg>, 
                  label: 'Twitter' 
                },
                { icon: <Globe size={18} color="white" />, label: 'Web' }
              ].map(social => (
                <button 
                  key={social.label} 
                  className="w-12 h-12 bg-[#4B3621] rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-md group"
                  title={social.label}
                >
                  {social.icon}
                </button>
          ...
          <div className="bg-[#F5EFE6] p-8 rounded-[40px] shadow-sm hover:shadow-md transition-all duration-500 border border-white/50 group cursor-pointer">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="w-12 h-12 bg-[#4B3621] rounded-full flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
